...
public class Conot extends JDialog {
	...
	private Canvas3D canvas3D;
		...
		public BranchGroup crearGrafoEscena() {
			...
			Color3f rojo = new Color3f(Color.cyan);
			...
			Cone tiangu = new Cone(CentroEstudios.getInstance().getTamCubo()/10+0.2f,0.5f,app);
		    mouseG.addChild(tiangu);
