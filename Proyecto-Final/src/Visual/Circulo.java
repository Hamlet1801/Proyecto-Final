...
public class Circulo extends JDialog {
	...
	public BranchGroup crearGrafoEscena() {
		...
		Color3f rojo = new Color3f(Color.PINK);
		ColoringAttributes eso = new ColoringAttributes();
		eso.setColor(rojo);
		app.setColoringAttributes(eso);
	   
	   
		Sphere esf = new Sphere(CentroEstudios.getInstance().getTamCubo()/10+0.2f,app);
